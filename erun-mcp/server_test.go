...
var wantRegisteredTools = []string{
	...
	"exec_merge", "exec_plan-ruleset-bypass", "exec_push", "exec_raw", "exec_reconcile-bypass", "exec_report-commit-status", "exec_write", "expose", "gate_list", "gate_show", "idle", "idle_stop_cancel",
