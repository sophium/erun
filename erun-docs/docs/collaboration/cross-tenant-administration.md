...
Signed in as an Operator on an **OPERATIONS** tenant, the console's **scope selector** lets you administer a **COMPANY** tenant's resources — starting with its environments — without switching who you're signed in as.
