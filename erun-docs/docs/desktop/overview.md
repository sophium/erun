...
Toggle the switch off when you're done. The contribute tabs close, the diff view reverts to the env, and the clone stays on disk so re-enabling later is instant.
