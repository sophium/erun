...
func requireRemoteShellScriptPatterns(t *testing.T, script, remoteWorkdir string) {
	...
	for _, pattern := range []string{
		...
		"/bin/bash --rcfile \"$HOME/.erun/tenant-a/local/bashrc\" -i || shell_status=$?",
