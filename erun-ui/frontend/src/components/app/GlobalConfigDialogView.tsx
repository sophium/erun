...
function cloudProviderSummary(provider: {
  provider: string;
  username?: string;
  accountId?: string;
}): string {
...
function cloudContextSummary(context: {
