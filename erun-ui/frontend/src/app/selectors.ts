...
export const selectEnvironmentExists = (state: RootState, tenant: string, environment: string): boolean =>
  Boolean(
...
export const selectSelectedIsPendingFor = (state: RootState, tenant: string, environment: string): boolean => {
