...
// in the frontend listened for the marker (erun#2017) -- it was queued,
// occupied a slot, and was discarded by the dispatcher's exact-name lookup,
// so the tab it exists to protect kept rendering whatever its last-received
// event left behind with no visible sign anything was wrong. This drives the
// exact reserved event through the real SSE transport -- the same
