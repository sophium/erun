...
func TestCreateEnvironmentStartsDeployWithResourceCaps(t *testing.T) {
	...
	EnvironmentRoutes{
		environments: environments,
		contexts:     &stubContextRepository{},
		quotas:       stubTenantQuotaRepository{maxEnvironments: 10, maxCPUMillicores: 9000, maxMemoryMB: 37000, maxStorageGB: 100},
		tenants:      stubConfigTenantRepository{tenant: model.Tenant{Name: "acme"}},
		provisioner:  prov,
	}.createEnvironment(rec, req)
	...
	got := prov.started[0]
	if got.MaxCPUMillicores != 9000 || got.MaxMemoryMB != 37000 || got.MaxStorageGB != 100 {
		t.Fatalf("resource caps = %+v, want 9000/37000/100", got)
	}
}
...
func TestCreateEnvironmentRejectsAggregateBudgetExceeded(t *testing.T) {
	...
	EnvironmentRoutes{
		...
		quotas: stubTenantQuotaRepository{
			maxEnvironments: 10, maxCPUMillicores: 8000, maxMemoryMB: 36864, maxStorageGB: 72,
			maxTotalCPUMillicores: 8000, maxTotalMemoryMB: 36864, maxTotalStorageGB: 72,
		},
		tenants:     stubConfigTenantRepository{tenant: model.Tenant{Name: "acme"}},
		provisioner: prov,
	}.createEnvironment(rec, req)
...
func TestCreateEnvironmentAllowsWithinAggregateBudget(t *testing.T) {
	...
	EnvironmentRoutes{
		...
		quotas: stubTenantQuotaRepository{
			maxEnvironments: 10, maxCPUMillicores: 8000, maxMemoryMB: 36864, maxStorageGB: 72,
			maxTotalCPUMillicores: 16000, maxTotalMemoryMB: 73728, maxTotalStorageGB: 144,
		},
		tenants:     stubConfigTenantRepository{tenant: model.Tenant{Name: "acme"}},
		provisioner: prov,
	}.createEnvironment(rec, req)
...
func TestDeployEnvironmentRejectsAggregateBudgetExceeded(t *testing.T) {
	...
	EnvironmentRoutes{
		...
		quotas: stubTenantQuotaRepository{
			maxEnvironments: 10, maxCPUMillicores: 8000, maxMemoryMB: 36864, maxStorageGB: 72,
			maxTotalCPUMillicores: 4000, maxTotalMemoryMB: 36864, maxTotalStorageGB: 72,
		},
		tenants:     stubConfigTenantRepository{tenant: model.Tenant{Name: "acme"}},
		provisioner: prov,
