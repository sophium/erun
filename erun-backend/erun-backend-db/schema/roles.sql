...
GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES
  ON users, user_external_ids, roles, role_permissions, user_roles, reviews, review_merge_queue, builds, comments, contexts, environments, tenant_quotas, cloud_provider_aliases, context_credentials
