...
GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES
  ON users, user_external_ids, roles, role_permissions, user_roles, reviews, review_merge_queue, review_reviewers, builds, releases, comments, contexts, environments, tenant_quotas, cloud_provider_aliases, context_credentials, invites, invite_requests, gate_runs, ai_sessions, jobs
