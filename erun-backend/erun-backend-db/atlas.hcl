...
env "default" {
  src = [
    ...
    "file://schema/tables/review_reviewers.sql",
    "file://schema/tables/builds.sql",
    "file://schema/tables/releases.sql",
    ...
    "file://schema/indexes/review_reviewers.sql",
    "file://schema/indexes/builds.sql",
    "file://schema/indexes/releases.sql",
    ...
    "file://schema/rls/review_reviewers.sql",
    "file://schema/rls/builds.sql",
    "file://schema/rls/releases.sql",
