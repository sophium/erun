...
//   - a bare word with no slash, directly touching a hash sign and a
//     number -- the repository's own short form for naming a reference
//     without an owner/repo prefix
...
//     or ".../pull/<n>")
//
// The bare hash-number alternative, and its bare-word sibling, are
// intentionally the widest of the five: they are what actually catch a new
// prefix wording this pattern was never told about, at the cost of also
// matching a rare non-issue use of a hash sign directly touching digits
// (a cryptography standard name is one real example, and so is a numeric
// hex color code). That tradeoff mirrors bareRequiredInputPattern's own
// "generalize the shape, accept the rare coincidental match" choice,
// because the alternative -- enumerating phrasings -- is the exact failure
// this gate exists to not repeat; a coincidental match is baselined like any
// other pre-existing hit rather than clawed back by narrowing the pattern.
// The bare-word alternative needs no lookbehind trick the way the bare-hash
// one does: consuming the word itself as part of the match sidesteps RE2's
// missing lookbehind entirely, since there is no separate character to
// stand in for a boundary check.
var issueReferencePattern = regexp.MustCompile(`(?i)issue\s*#\s*\d+|[\w][\w.-]*/[\w][\w.-]*#\d+|[\w][\w.-]*#\d{2,6}\b|(?:^|[^\w#])(#\d{2,6})\b|github\.com/[\w.-]+/[\w.-]+/(?:issues|pull)/\d+`)
...
var issueReferenceBaseline = map[string]int{
	"erun-backend/erun-backend-api/auth.go":                                          2,
	"erun-backend/erun-backend-api/auth_test.go":                                     4,
	"erun-backend/erun-backend-api/cmd/eapi/main_e2e_test.go":                        1,
	...
	"erun-backend/erun-backend-api/internal/deployexec/lifecycle_job_test.go":        4,
	...
	"erun-backend/erun-backend-api/internal/gitverify/verifier_test.go":              1,
	"erun-backend/erun-backend-api/internal/model/build.go":                          1,
	...
	"erun-backend/erun-backend-api/internal/provision/runtime_image_checker_test.go": 1,
	"erun-backend/erun-backend-api/internal/repository/environments.go":              14,
	"erun-backend/erun-backend-api/internal/repository/identity.go":                  1,
	"erun-backend/erun-backend-api/internal/repository/identity_e2e_test.go":         8,
	"erun-backend/erun-backend-api/internal/repository/identity_test.go":             1,
	...
	"erun-backend/erun-backend-api/internal/repository/tenant_issuers_e2e_test.go":   2,
	...
	"erun-backend/erun-backend-api/internal/repository/tenants.go":                   1,
	"erun-backend/erun-backend-api/internal/repository/tenants_e2e_test.go":          2,
	"erun-backend/erun-backend-api/internal/repository/tenants_test.go":              1,
	"erun-backend/erun-backend-api/internal/routeroles/route_roles.go":               1,
	"erun-backend/erun-backend-api/internal/routes/builds.go":                        1,
	...
	"erun-backend/erun-backend-api/internal/routes/errors.go":                        1,
	"erun-backend/erun-backend-api/internal/routes/errors_test.go":                   2,
	...
	"erun-backend/erun-backend-api/internal/routes/invite_requests_test.go":          1,
	...
	"erun-backend/erun-backend-api/internal/routes/mcp_token.go":                     3,
	"erun-backend/erun-backend-api/internal/routes/mcp_token_test.go":                8,
	"erun-backend/erun-backend-api/internal/routes/provision.go":                     3,
	"erun-backend/erun-backend-api/internal/routes/route_audit.go":                   1,
	...
	"erun-backend/erun-backend-api/internal/routes/tenants_test.go":                  2,
	...
	"erun-backend/erun-backend-api/reconcile_bootstrap_name_e2e_test.go":             1,
	"erun-backend/erun-backend-api/registry_token_route_test.go":                     1,
	"erun-backend/erun-backend-api/role_policy_e2e_test.go":                          5,
	"erun-backend/erun-backend-api/server.go":                                        8,
	"erun-cli/cmd/doctor_host_credentials.go":                                        1,
	"erun-cli/cmd/doctor_pod_diagnosis.go":                                           1,
	"erun-cli/cmd/job.go":                                                            1,
	"erun-cli/cmd/list.go":                                                           1,
	"erun-cli/cmd/mcp_proxy.go":                                                      2,
	"erun-cli/cmd/port_forward_state_test.go":                                        1,
	...
	"erun-common/build_types.go":                          1,
	"erun-common/close_pull_request.go":                   1,
	"erun-common/cloud_erun_test.go":                      1,
	"erun-common/cloud_host_credentials.go":               1,
	"erun-common/cloud_host_credentials_test.go":          1,
	"erun-common/config.go":                               2,
	"erun-common/config_atomic_test.go":                   1,
	"erun-common/config_roundtrip_test.go":                1,
	"erun-common/control_plane_version_drift.go":          2,
	"erun-common/deploy.go":                               5,
	"erun-common/deploy_helm_output_race_test.go":         1,
	"erun-common/deploy_image_pull_secret.go":             1,
	"erun-common/deploy_kubernetes_check_test.go":         2,
	"erun-common/deploy_parallel_race_test.go":            1,
	"erun-common/deploy_persist_runtime_version_test.go":  1,
	"erun-common/deploy_runtime_image_line_guard.go":      1,
	"erun-common/deploy_runtime_image_line_guard_test.go": 1,
	"erun-common/doctor_deploy_test.go":                   4,
	"erun-common/doctor_remote_init_test.go":              1,
	"erun-common/doctor_sync_config_test.go":              3,
	"erun-common/environment_type_test.go":                1,
	"erun-common/exec_commit_stderr_test.go":              1,
	"erun-common/exec_gate_merge_stderr_test.go":          1,
	...
	"erun-common/job_agent.go":                            1,
	"erun-common/job_exclusive.go":                        1,
	...
	"erun-common/mcp_capabilities.go":                     3,
	"erun-common/mcp_capabilities_test.go":                1,
	"erun-common/mcp_reachability.go":                     1,
	"erun-common/mcp_tools.go":                            1,
	...
	"erun-common/platform_client_builds.go":               1,
	...
	"erun-common/release_stderr_test.go":                  1,
	"erun-common/review_commands.go":                      1,
	"erun-common/runtime_resources.go":                    4,
	"erun-common/runtime_usage.go":                        1,
	"erun-common/runtime_usage_test.go":                   1,
	"erun-common/runtime_version_line.go":                 3,
	"erun-common/runtime_version_line_test.go":            1,
	"erun-common/stop_stderr_test.go":                     1,
	"erun-common/upgrade.go":                              2,
	"erun-common/upgrade_resolver_test.go":                6,
	"erun-common/version_drift.go":                        1,
	"erun-common/whip_environment_test.go":                1,
	"erun-common/work_clone_reclaim_stderr_test.go":       1,
	"erun-common/workspace_sync_outputs_test.go":          3,
	"erun-devops/dns01-webhook/solver.go":                 1,
	"erun-devops/dns01-webhook/solver_test.go":            1,
	"erun-integration/activity_test.go":                   2,
	"erun-integration/build_test.go":                      14,
	"erun-integration/delete_test.go":                     3,
	"erun-integration/deploy_test.go":                     16,
	"erun-integration/desktop_surface_test.go":            2,
	"erun-integration/doctor_test.go":                     11,
	"erun-integration/environment_half_scenarios_test.go": 8,
	"erun-integration/exec_test.go":                       4,
	"erun-integration/init_test.go":                       3,
	"erun-integration/list_control_planes_test.go":        3,
	"erun-integration/list_test.go":                       8,
	"erun-integration/mcp_test.go":                        1,
	"erun-integration/observe_test.go":                    7,
	"erun-integration/open_test.go":                       3,
	"erun-integration/platform_test.go":                   3,
	...
	"erun-mcp/activity_lease_test.go":                     1,
	"erun-mcp/agent.go":                                   1,
	"erun-mcp/capabilities.go":                            1,
	"erun-mcp/capabilities_test.go":                       4,
	"erun-mcp/exec.go":                                    1,
	"erun-mcp/job_envelope.go":                            1,
	"erun-mcp/job_target_test.go":                         1,
	"erun-mcp/mcp_overview_doc_test.go":                   1,
	"erun-mcp/metrics_test.go":                            1,
	"erun-mcp/platform.go":                                1,
	"erun-mcp/platform_user_enroll_roles_test.go":         1,
	"erun-mcp/runtime.go":                                 1,
	"erun-mcp/server.go":                                  5,
	"erun-mcp/server_test.go":                             4,
	"erun-mcp/tool_metadata_test.go":                      1,
	"erun-ui/activity_queue_app_test.go":                  1,
	"erun-ui/ai_occupancy_test.go":                        1,
	"erun-ui/api_log_test.go":                             1,
	"erun-ui/app_restart.go":                              2,
	"erun-ui/app_restart_test.go":                         1,
	...
	"erun-ui/environment_activity_test.go":                1,
	"erun-ui/host_open_path.go":                           1,
	"erun-ui/host_open_path_test.go":                      1,
	"erun-ui/idle_status_test.go":                         1,
	"erun-ui/mcp_errors.go":                               1,
	"erun-ui/orchestrator.go":                             2,
	"erun-ui/orchestrator_conversations.go":               2,
	"erun-ui/orchestrator_conversations_test.go":          2,
	...
	"erun-ui/orchestrator_pacing_test.go":                 5,
	...
	"erun-ui/tenant_dashboard.go":                         4,
	"erun-ui/tenant_dashboard_test.go":                    1,
	"erun-ui/tenant_platform.go":                          3,
	"erun-ui/tenant_platform_enroll_test.go":              1,
	"erun-ui/tenant_platform_test.go":                     3,
	...
	"erun-ui/whip.go":                                     1,
	"erun-ui/whip_test.go":                                5,
	"erun-ui/window_close_test.go":                        1,
}
...
func TestIssueReferencePatternCatchesShapeVariants(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		// The repository's own short form: no slash, no "issue" prefix, and
		// the character before "#" is a word character rather than the
		// whitespace/punctuation the bare-hash alternative needs.
		{"erun#9999", true},
		{"(erun#9999: a note)", true},
		{"# Overview", false},
		...
		// own comment): a cryptography standard name that happens to share
		// the "word directly touching #digits" shape a real short-form
		// reference has. Baselined in production code rather than narrowed
		// away here.
		{"PKCS#12", true},
	} {
