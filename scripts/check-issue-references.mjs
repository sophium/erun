...
// issueReferencePattern exactly: a bare hash-number, a bare word with no
// slash directly touching a hash sign and a number -- the repository's own
// short form for naming a reference without an owner/repo prefix -- an
// "issue #" prefix, a cross-repo "owner/repo#" form, or a full GitHub
// issue/pull URL. Group 1 captures just the "#NNN"
// portion of the bare-hash alternative (JS regex has no lookbehind either,
// so the boundary character before "#" must be consumed by the match);
// every other alternative's match, including the bare-word one, is already
// exactly the reference text -- the bare-word alternative consumes its own
// word as part of the match, so it needs no boundary trick at all.
export const issueReferencePattern =
  /issue\s*#\s*\d+|[\w][\w.-]*\/[\w][\w.-]*#\d+|[\w][\w.-]*#\d{2,6}\b|(?:^|[^\w#])(#\d{2,6})\b|github\.com\/[\w.-]+\/[\w.-]+\/(?:issues|pull)\/\d+/i;
...
export const issueReferenceBaseline = {
  'erun-console/src/App.test.tsx': 4,
  'erun-console/src/App.tsx': 7,
  'erun-console/src/app/api/configApi.ts': 1,
  'erun-console/src/app/api/environmentsApi.ts': 1,
  'erun-console/src/app/api/gateRunsApi.ts': 1,
  'erun-console/src/app/api/identityApi.ts': 2,
  'erun-console/src/app/api/mcpApi.ts': 1,
  'erun-console/src/app/api/platformUsersApi.ts': 1,
  'erun-console/src/app/queryError.ts': 1,
  'erun-console/src/auth/auth.test.ts': 2,
  'erun-console/src/auth/auth.ts': 2,
  ...
  'erun-console/src/environments/EnvironmentsPanel.test.tsx': 2,
  'erun-console/src/environments/EnvironmentsPanel.tsx': 2,
  'erun-console/src/gateRuns/GateRunsPanel.test.tsx': 2,
  'erun-console/src/gateRuns/GateRunsPanel.tsx': 2,
  'erun-console/src/identity/AcceptInvitePage.tsx': 2,
  'erun-console/src/identity/EnrollUserForm.tsx': 1,
  'erun-console/src/identity/InvitesPanel.tsx': 2,
  'erun-console/src/identity/OrgSettingsPanel.tsx': 1,
  'erun-console/src/identity/PlatformEnrollFields.tsx': 1,
  'erun-console/src/identity/SmtpSettingsPanel.tsx': 1,
  'erun-console/src/identity/UsersPanel.test.tsx': 1,
  'erun-console/src/identity/UsersPanel.tsx': 2,
  'erun-console/src/identity/controller.ts': 1,
  'erun-console/src/identity/platformEnrollController.ts': 1,
  'erun-console/src/quota/QuotaPanel.tsx': 1,
  'erun-console/src/shell/AppShell.test.tsx': 1,
  'erun-console/src/shell/AppShell.tsx': 3,
  'erun-console/src/shell/ConsoleSidebar.tsx': 1,
  'erun-console/src/shell/PreShellScreens.test.tsx': 2,
  'erun-console/src/shell/PreShellScreens.tsx': 2,
  'erun-console/src/shell/ScopeSelector.tsx': 1,
  'erun-console/src/shell/landingContent.ts': 1,
  'erun-console/src/shell/sections.ts': 4,
  'erun-console/src/shell/useTenantTargetSelection.ts': 1,
  'erun-console/src/tenants/EnrollTenantUserDialog.tsx': 1,
  'erun-console/src/tenants/TenantsPanel.test.tsx': 1,
  'erun-console/src/tenants/TenantsPanel.tsx': 1,
  'erun-kit/src/api/platformConfigEndpoints.test.ts': 1,
  'erun-kit/src/api/platformConfigEndpoints.ts': 2,
  ...
  'erun-ui/frontend/src/app/aiOccupancyThunks.ts': 1,
  'erun-ui/frontend/src/app/api/platformConfigEndpoints.test.ts': 1,
  'erun-ui/frontend/src/app/bootThunks.test.ts': 1,
  'erun-ui/frontend/src/app/bootThunks.ts': 2,
  ...
  'erun-ui/frontend/src/app/envActivitySeed.test.ts': 1,
  'erun-ui/frontend/src/app/envActivitySeed.ts': 1,
  ...
  'erun-ui/frontend/src/app/orchestratorEnvironmentActivity.test.ts': 1,
  'erun-ui/frontend/src/app/orchestratorRestore.ts': 1,
  ...
  'erun-ui/frontend/src/app/selectors.ts': 5,
  ...
  'erun-ui/frontend/src/app/slices/closeGateSlice.ts': 1,
  'erun-ui/frontend/src/app/slices/orchestratorsSlice.ts': 2,
  ...
  'erun-ui/frontend/src/app/tenantDashboardPanels.ts': 3,
  'erun-ui/frontend/src/app/tenantDialogThunks.ts': 1,
  ...
  'erun-ui/frontend/src/app/whipTargetSelection.ts': 3,
  'erun-ui/frontend/src/components/app/AIOccupancyBanner.tsx': 1,
  'erun-ui/frontend/src/components/app/AIOccupancyPromptDialog.tsx': 1,
  'erun-ui/frontend/src/components/app/CloseConfirmDialog.tsx': 1,
  ...
  'erun-ui/frontend/src/components/app/OrchestratorDialog.tsx': 1,
  ...
  'erun-ui/frontend/src/components/app/Sidebar.ErunSection.tsx': 1,
  ...
  'erun-ui/frontend/src/components/app/Titlebar.WhipAction.tsx': 3,
  'erun-ui/frontend/src/components/app/Titlebar.helpers.test.ts': 1,
